...
<{background:gray}[en](test). |\2. this is|{background:red;width:200px}. a|^<>{height:200px}. row|
|this|<>{padding:10px}. is|^. another|>(bob#bob). row|

An image:

!http://dailyjs.com/images/posts/d3.jpg(optional alt text)!

# Librarians rule
# Yes they do
# But you knew that

Some more text of dubious character. Here is some string of CAPITAL letters. Here is something we want to _emphasize_. 
